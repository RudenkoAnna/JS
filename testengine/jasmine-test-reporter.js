...
jasmine.TestReporter.prototype.createDom = function (
  type,
  attrs,
  childrenVarArgs
) {
...
jasmine.TestReporter.prototype._createDescribeResults = function (
  suite,
  isTopTask
) {
  ...
  for (var i = 0; i < tasks.length; ++i) {
    ...
    if (
      ...
      (results.state === "passed" && taskState === "no-tests")
    ) {
